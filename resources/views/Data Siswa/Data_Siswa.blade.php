                            ...
                            @foreach ($dtsiswa as $dt_siswa)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#_detail-{{ $dt_siswa->id }}"><i class="fas fa-eye" title="Detail"></i></a>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#_detail-{{ $dt_siswa->id }}"><i class="fas fa-eye" title="Detail"></i>Detail</a>
                                        {{-- <a href="#" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#_edit-{{ $dt_siswa->id }}"><i class="fas fa-edit" title="Edit"></i>Beri Nilai</a> --}}
                                        <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#_hapus-{{ $dt_siswa->id }}"><i class="fas fa-trash" title="Delete"></i>Hapus</a>
                                    </td>
                                    @endif
